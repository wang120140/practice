...
Page({
  ...
  listto: function () {
    ...
    switch (listdata) {
      case "立春":
        wx.navigateTo({
          url: '../lichun/lichun?uname=lichun',
  ...
  lichun: function (options) {
    console.log('立春事件发生......');
    console.log(options);
    wx.navigateTo({
      url: '../lichun/lichun?uname='+options.target.dataset.menuitem,
    })
  },
  jingzhe: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=jingzhe',
    })
  },

  chunfen: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=chunfen',
    })
  },
  yushui: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=yushui',
    })

  },
  qingming: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=qingming',
    })

  },
  guyu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=guyu',
    })

  },
  lixia: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=lixia',
    })
  ...
  xiaoman: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=xiaoman',
    })
  ...
  mangzhong: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=mangzhong',
    })

  },
  xiazhi: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=xiazhi',
    })
  ...
  xiaoshu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=xiaoshu',
    })

  },
  dashu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=dashu',
    })

  },
  liqiu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=liqiu',
    })
  ...
  chushu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=chushu',
    })

  },
  bailu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=bailu',
    })

  },
  qiufen: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=qiufen',
    })
  ...
  hanlu: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=hanlu',
    })

  },
  shuangjiang: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=shuangjiang',
    })
  ...
  lidong: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=lidong',
    })

  },
  xiaoxue: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=xiaoxue',
    })

  },
  daxue: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=daxue',
    })

  },
  dongzhi: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=dongzhi',
    })

  },
  xiaohan: function () {
    wx.navigateTo({
      url: '../lichun/lichun?uname=xiaohan',
    })
